...
eststo t1: qui areg lcodtot_c1_i_rate_w treat_post i.time_quarter county if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)

eststo t2: qui areg lcodtot_c1_i_rate_w treat_post i.time_quarter $covar2 county if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)

eststo t3: qui areg lcodtot_c1_i_rate_w_dt treat_post i.time_quarter county trend if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)

eststo t4: qui areg lcodtot_c1_i_rate_w_dt treat_post i.time_quarter $covar2 county trend if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)
...
eststo t1: qui areg lcodtot_c1_i_rate_w treat_post i.time_quarter i.fips Gr if timeframe == 1 [aw = tot_pop2000], a(group_year) cluster(group_year)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)

eststo t2: qui areg lcodtot_c1_i_rate_w treat_post i.time_quarter i.fips $covar2 Gr if timeframe == 1 [aw = tot_pop2000], a(group_year) cluster(fips)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)

eststo t3: qui areg lcodtot_c1_i_rate_w_dt treat_post i.time_quarter i.fips Gr trend if timeframe == 1 [aw = tot_pop2000], a(group_year) cluster(group_year)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)

eststo t4: qui areg lcodtot_c1_i_rate_w_dt treat_post i.time_quarter i.fips $covar2 Gr trend if timeframe == 1 [aw = tot_pop2000], a(group_year) cluster(fips)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)
