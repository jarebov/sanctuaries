...
eststo t1: qui areg log_tot treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.time_quarter  county if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
...
eststo t2: qui areg log_tot treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.time_quarter  $covar2 county if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
disp _b[treat_post_hisp1]
disp _b[treat_post_hisp1]/_se[treat_post_hisp1]
disp _b[treat_post_hisp2]
disp _b[treat_post_hisp2]/_se[treat_post_hisp2]
...
preserve
	qui areg log_tot c.year#i.fips treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.time_quarter if post == 0 [aw=tot_pop], a(fips)
	codebook fips if e(sample)
	mat b=e(b)
	mat b=b[1,1..374]
	mat score res1 = b
	gen res2 =  log_tot -  res1
	eststo t3: qui areg res2 treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.time_quarter trend county if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
	disp _b[treat_post_hisp1]
	disp _b[treat_post_hisp1]/_se[treat_post_hisp1]
	disp _b[treat_post_hisp2]
	disp _b[treat_post_hisp2]/_se[treat_post_hisp2]
...
preserve
	qui areg log_tot c.year#i.fips treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.quarter i.year $covar2 if post == 0 [aw=tot_pop], a(fips)
	codebook fips if e(sample)
	mat b=e(b)
	mat b=b[1,1..367]
	mat score res1 = b
	gen res2 =  log_tot -  res1
	eststo t4: qui areg res2 treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.quarter i.year $covar2 county trend if timeframe == 1 [aw = tot_pop2000], a(fips) rob cluster(fips)
	disp _b[treat_post_hisp1]
	disp _b[treat_post_hisp1]/_se[treat_post_hisp1]
	disp _b[treat_post_hisp2]
	disp _b[treat_post_hisp2]/_se[treat_post_hisp2]
...
* Table 4: only violent
eststo t1: qui areg log_violent treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.time_quarter county if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
disp _b[treat_post_hisp1]
disp _b[treat_post_hisp1]/_se[treat_post_hisp1]
disp _b[treat_post_hisp2]
disp _b[treat_post_hisp2]/_se[treat_post_hisp2]
...
eststo t2: qui areg log_violent treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.time_quarter  county $covar2 if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
disp _b[treat_post_hisp1]
disp _b[treat_post_hisp1]/_se[treat_post_hisp1]
disp _b[treat_post_hisp2]
disp _b[treat_post_hisp2]/_se[treat_post_hisp2]
...
preserve
	qui areg log_violent c.year#i.fips treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.time_quarter if post == 0 [aw=tot_pop], a(fips)
	codebook fips if e(sample)
	mat b=e(b)
	mat b=b[1,1..374]
	mat score res1 = b
	gen res2 =  log_violent -  res1
	eststo t3: qui areg res2 treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.time_quarter county trend if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
	disp _b[treat_post_hisp1]
	disp _b[treat_post_hisp1]/_se[treat_post_hisp1]
	disp _b[treat_post_hisp2]
	disp _b[treat_post_hisp2]/_se[treat_post_hisp2]
...
preserve
	qui areg log_violent c.year#i.fips treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.quarter i.year $covar2 if post == 0 [aw=tot_pop], a(fips)
	codebook fips if e(sample)
	mat b=e(b)
	mat b=b[1,1..367]
	mat score res1 = b
...
* Table 4: only property
eststo t1: qui areg log_property treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.time_quarter county if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
disp _b[treat_post_hisp1]
disp _b[treat_post_hisp1]/_se[treat_post_hisp1]
disp _b[treat_post_hisp2]
disp _b[treat_post_hisp2]/_se[treat_post_hisp2]
...
eststo t2: qui areg log_property treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.time_quarter  $covar2 county if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
disp _b[treat_post_hisp1]
disp _b[treat_post_hisp1]/_se[treat_post_hisp1]
disp _b[treat_post_hisp2]
disp _b[treat_post_hisp2]/_se[treat_post_hisp2]
...
preserve
	qui areg log_property c.year#i.fips treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.time_quarter if post == 0 [aw=tot_pop], a(fips)
	codebook fips if e(sample)
	mat b=e(b)
	mat b=b[1,1..374]
	mat score res1 = b
...
preserve
	qui areg log_property c.year#i.fips treat_post_hisp1 treat_post_hisp2 treat_post_hisp3 treat_post_hisp4 i.quarter i.year $covar2 if post == 0 [aw=tot_pop], a(fips)
	codebook fips if e(sample)
	mat b=e(b)
	mat b=b[1,1..367]
	mat score res1 = b
