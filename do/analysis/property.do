...
eststo t1: qui areg log_property treat_post i.time_quarter county if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)

eststo t2: qui areg log_property treat_post i.time_quarter $covar2 county if timeframe == 1 [aw = tot_pop2000], a(fips) cluster(fips)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)

preserve
	qui areg log_property c.year#i.fips treat_post i.time_quarter if post == 0 [aw=tot_pop], a(fips)
	codebook fips if e(sample)
	mat b=e(b)
	mat b=b[1,1..374]
	mat score res1 = b
	gen res2 =  log_property -  res1
...
preserve
	qui areg log_property c.year#i.fips treat_post i.quarter i.year $covar2 if post == 0 [aw=tot_pop], a(fips)
	codebook fips if e(sample)
	mat b=e(b)
	mat b=b[1,1..367]
	mat score res1 = b
...
eststo t1: qui areg log_property treat_post i.time_quarter i.fips Gr if timeframe == 1 [aw = tot_pop2000], a(group_year) cluster(fips)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)

eststo t2: qui areg log_property treat_post i.time_quarter i.fips $covar2 Gr if timeframe == 1 [aw = tot_pop2000], a(group_year) cluster(fips)
disp _b[treat_post]
disp _b[treat_post]/_se[treat_post]
disp e(N)

preserve
	qui areg log_property c.year#i.fips treat_post  i.fips i.time_quarter if post == 0 [aw=tot_pop], a(group_year)
	codebook fips if e(sample)
	mat b=e(b)
	mat b=b[1,1..374]
	mat score res1 = b
...
preserve
	qui areg log_property c.year#i.fips treat_post  i.fips i.quarter i.year $covar2 if post == 0 [aw=tot_pop], a(fips)
	codebook fips if e(sample)
	mat b=e(b)
	mat b=b[1,1..367]
	mat score res1 = b
